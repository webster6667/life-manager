...
app.whenReady().then(() => {
  ...
  ipcMain.handle('moveFile', (_, ...args: Parameters<typeof moveFile>) => moveFile(...args))
  ...
  ipcMain.handle('deleteFile', (_, filePath: string) => deleteFile(filePath))
  ipcMain.handle('createDirectory', (_, dirPath: string) => createDirectory(dirPath))
