...
import type { IBackgroundComponentProps } from '@easy-diagram/states/diagramSettings'

const SvgBackground: React.FC<IBackgroundComponentProps<ISvgBackgroundSettings>> = observer(
