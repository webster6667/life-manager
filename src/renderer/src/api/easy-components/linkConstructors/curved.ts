import { commandC, createVector, getRadian } from '@easy-diagram/linkConstructors/utils'
import { distanceBetweenPoints } from '@easy-diagram/utils/point'
...
export function createCurvedLinkPathConstructor(
  ...
  return (source: ILinkPathConstructorEndpointInfo, target: ILinkPathConstructorEndpointInfo) =>
