...
} from '@easy-diagram/states/visualComponentState'
...
export class VisualComponentWithDefault<TComponentProps> {
  ...
  constructor(defaultComponent: IComponentDefinition<TComponentProps, any>) {
    this._innerComponent = new VisualComponentState<TComponentProps, any>(defaultComponent)
  ...
  import = (
    newComponent?: IComponentDefinition<TComponentProps, any> | VisualComponent<TComponentProps>
  ) => {
