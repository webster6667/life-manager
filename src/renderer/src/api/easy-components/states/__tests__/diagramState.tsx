import { DiagramState, IDiagramState } from '@easy-diagram/states/diagramState'
import { RootStore } from '@easy-diagram/states/rootStore'
import { BoundingBox } from '@easy-diagram/utils/common'
...
describe('Diagram state', () => {
  ...
  describe('Zoom', () => {
    ...
    test('Zoom value larger than max allowed should be clamped', () => {
      ...
      expect(diagramState.zoom).toEqual(rootStore.diagramSettings.zoomInterval[1])
    })
    ...
    test('Zoom value smaller than min allowed should be clamped', () => {
      ...
      expect(diagramState.zoom).toEqual(rootStore.diagramSettings.zoomInterval[0])
    })
