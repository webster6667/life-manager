...
import { UserInteractionSettings } from '@easy-diagram/states/userInteractionSettings'
...
describe('Diagram settings', () => {
  ...
  test('Import', () => {
    ...
    expect(settings.backgroundComponentState.component).toBe(newSettings.backgroundComponent)
    expect(settings.miniControlComponentState.component).toBe(newSettings.miniControlComponent)
