import { ICallbacks, OnDrag, OnDragEnded, OnDragStarted } from '@easy-diagram/states/callbacks'
...
describe('Drag state', () => {
  ...
  const validateOnDragStartedCallbackCall = (invocation: number, expected: OnDragStarted) => {
  ...
  const validateOnDragEndedCallbackCall = (invocation: number, expected: OnDragEnded) => {
