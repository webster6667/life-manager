...
import { createLinkDefault, LinkDefault } from '@easy-diagram/components/link/LinkDefault'
import { createCurvedLinkPathConstructor } from '@easy-diagram/linkConstructors/curved'
...
} from '@easy-diagram/states/linkCreationState'
...
import { createArrowMarker, createCircleMarker } from '@easy-diagram/components/link/Markers'
import { ReactDOMAttributes } from '@use-gesture/react/dist/declarations/src/types'

export class LinksSettings {
  private _pathConstructor: ILinkPathConstructor
  private _visualComponents = new VisualComponents<any, ILinkVisualComponentProps>({
...
export interface ILinksSettings extends IVisualComponentsObject<any, ILinkVisualComponentProps> {
