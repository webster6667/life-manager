...
import { deepCopy } from '@easy-diagram/utils/common'
import { addPoints, multiplyPoint, Point } from '@easy-diagram/utils/point'
...
export function linkPortEndpointsEquals(a: ILinkPortEndpoint, b: ILinkPortEndpoint): boolean {
