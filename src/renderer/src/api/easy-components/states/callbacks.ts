import { INodeExport, INodeState, NodeState } from '@easy-diagram/states/nodeState'
...
import { ErrorResult } from '@easy-diagram/utils/result'
...
export class Callbacks {
  ...
  linkValidation = (info: OnLinkValidation) => {
    if (this._onLinkValidation) return this._onLinkValidation(info, this._rootStore)
    else return true
  }
...
export interface ICallbacks {
  ...
  onNodesRemoveResult?: (info: OnNodesRemoveResult, rootStore: RootStore) => void
  onNodePositionChanged?: (info: OnNodePositionChanged, rootStore: RootStore) => void
  ...
  onNodeIsDragEnabledChanged?: (info: OnNodeIsDragEnabledChanged, rootStore: RootStore) => void
...
export interface OnNodeLabelChanged extends OnNodePropertyChanged<string | undefined> {}

export interface OnNodeTypeChanged extends OnNodePropertyChanged<string | undefined> {}
...
export interface OnNodeIsDragEnabledChanged extends OnNodePropertyChanged<boolean | undefined> {}
