...
import { LinkPointEndpointState } from '@easy-diagram/states/linkPointEndpointState'
import {
...
export function createLinkPath(
  ...
  const pathStr = linksSettings.pathConstructor(
    ...
    {
      point: target.point,
      portType: target instanceof LinkPointEndpointState ? undefined : target.port!.type,
      direction: target instanceof LinkPointEndpointState ? undefined : target.port!.linkDirection
    }
  )
